...
class Login(Form):
    username = SelectField('نام دفتر',
                           choices=[('', ''), ('خانه عکاسان', 'خانه عکاسان'), ('روابط عمومی', 'روابط عمومی'),
                                    ('موسسه سپهر سوره مهر', 'موسسه سپهر سوره مهر'),
                                    ('مرکز آفرینش های ادبی', 'مرکز آفرینش های ادبی'), ('مرکز تجسمی', 'مرکز تجسمی'),
                                    ('مرکز ترجمه', 'مرکز ترجمه'), ('مرکز طنز', 'مرکز طنز'),
                                    ...
                                    ('اداره ارزیابی و نظارت', 'اداره ارزیابی و نظارت')])
...
class adding_record(Form):
    ...
    subject = SelectField(choices=[('', ''), ('نمایش', 'نمایش'), ('استودیو', 'استودیو'), ('پروژه_ها', 'پروژه ها'),
                                   ...
                                   ('جشنواره_ها_تفصیلی', 'جشنواره ها-تفصیلی'), ('کتاب', 'کتاب'), ('نشریه', 'نشریه')])
...
class enter_evaluation(Form):
    ...
    hold_displn = SelectField(
        choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                 ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
    advertising = SelectField(validators=[DataRequired()],
                              choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                                       ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
    sharee_time = SelectField(validators=[DataRequired()],
                              choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                                       ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
    decor_tansb = SelectField(validators=[DataRequired()],
                              choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                                       ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
    ...
    light_quality = SelectField(validators=[DataRequired()],
                                choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                                         ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
    area_adv = SelectField(validators=[DataRequired()],
                           choices=[('', ''), ('خوب', 'خوب'), ('متوسط', 'متوسط'), ('ضعیف', 'ضعیف'),
                                    ('موضوعیتی_ندارد', 'موضوعیتی ندارد')])
...
class amar_first_form(Form):
    username = SelectField('نام واحد',
                           choices=[('', ''), ('خانه عکاسان', 'خانه عکاسان'), ('روابط عمومی', 'روابط عمومی'),
                                    ('موسسه سپهر سوره مهر', 'موسسه سپهر سوره مهر'),
                                    ('مرکز آفرینش های ادبی', 'مرکز آفرینش های ادبی'), ('مرکز تجسمی', 'مرکز تجسمی'),
                                    ('مرکز ترجمه', 'مرکز ترجمه'),
                                    ('مرکز طنز', 'مرکز طنز'), ('مرکز مطالعات و تحقیقات فرهنگ و ادب پایداری',
                                                               'مرکز مطالعات و تحقیقات فرهنگ و ادب پایداری'),
                                    ('مرکز معماری', 'مرکز معماری'), ('مرکز موسیقی', 'مرکز موسیقی'),
                                    ('مرکز هنرهای نمایشی', 'مرکز هنرهای نمایشی'), ('کودک و نوجوان', 'کودک و نوجوان'),
                                    ('اداره ارزیابی و نظارت', 'اداره ارزیابی و نظارت')])
...
class eval_record(Form):
    subject = SelectField(choices=[('', ''), ('نمایش', 'نمایش'), ('استودیو', 'استودیو'), ('پروژه_ها', 'پروژه ها'),
                                   ...
                                   ('کارشناسی_آثار_مکتوب', 'کارشناسی آثار مکتوب'),
                                   ('جشنواره_ها_تفصیلی', 'جشنواره ها-تفصیلی'), ('کتاب', 'کتاب'), ('نشریه', 'نشریه')])
    evaluated = SelectField(choices=[(2, 'همه'), (0, 'ارزیابی نشده'), (1, 'ارزیابی شده')], default=0)
    search = SubmitField('جستجو')
...
class show_form(Form):
    ...
    salon = SelectField(
        choices=[('', ''), ('سالن اوستا', 'سالن اوستا'), ('سالن کنفرانس حوزه ریاست', 'سالن کنفرانس حوزه ریاست'),
                 ('سالن ابوالفضل عالی', 'سالن ابوالفضل عالی'),
                 ('سالن کنفرانس پژوهشگاه', 'سالن کنفرانس پژوهشگاه'), ('سالن سلمان هراتی', 'سالن سلمان هراتی'),
                 ('تالار سوره', 'تالار سوره'),
                 ('گالری شماره 2 خانه عکاسان ایران', 'گالری شماره 2 خانه عکاسان ایران'),
                 ('سالن استاد امیرحسین فردی', 'سالن استاد امیرحسین فردی'),
                 ('تالار اندیشه', 'تالار اندیشه'),
                 ('تالار مهر', 'تالار مهر'), ('تالار ماه', 'تالار ماه'),
                 ('محوطه حوزه هنری', 'محوطه حوزه هنری'),
                 ('روبروی مسجد حضرت آیت الله خامنه ای', 'روبروی مسجد حضرت آیت الله خامنه ای'),
                 ('گالری شماره 1 خانه عکاسان ایران', 'گالری شماره 1 خانه عکاسان ایران'),
                 ('کارگاه مجسمه سازی', 'کارگاه مجسمه سازی'),
                 ('مسجد حضرت آیت الله خامنه ای', 'مسجد حضرت آیت الله خامنه ای'), ('خانه عکاسان', 'خانه عکاسان'),
                 ('مرکز آفرینش های ادبی', 'مرکز آفرینش های ادبی'),
...
class festivals_form(Form):
    ...
    city = SelectField(choices=[('', ''), ('آذربایجان شرقی', 'آذربایجان شرقی'), ('آذربایجان غربی', 'آذربایجان غربی'),
                                ('اردبیل', 'اردبیل'),
...
class multimedia_form(Form):
    name = StringField(validators=[DataRequired()])
    frame = SelectField(
        choices=[('', ''), ('آنونس', 'آنونس'), ('تیزر', 'تیزر'), ('فتوکلیپ', 'فتوکلیپ'), ('مستند', 'مستند'),
                 ('وله', 'وله'), ('کلیپ', 'کلیپ')])
...
class plato_form(Form):
    ...
    program_kind = SelectField(choices=[('', ''), ('اجرای عمومی', 'اجرای عمومی'), ('جشنواره داخلی', 'جشنواره داخلی'),
                                        ('جشنواره مشارکت', 'جشنواره مشارکت')])
    back = SubmitField('بازگشت')
    add = SubmitField('ثبت')
    logout = SubmitField('خروج')
...
class congress_form(Form):
    ...
    office = SelectField(choices=[('', ''), ('خانه عکاسان', 'خانه عکاسان'), ('روابط عمومی', 'روابط عمومی'),
                                  ...
                                  ('مرکز طنز', 'مرکز طنز'), ('مرکز مطالعات و تحقیقات فرهنگ و ادب پایداری',
                                                             'مرکز مطالعات و تحقیقات فرهنگ و ادب پایداری'),
                                  ('مرکز معماری', 'مرکز معماری'),
                                  ('مرکز موسیقی', 'مرکز موسیقی'), ('مرکز هنرهای نمایشی', 'مرکز هنرهای نمایشی'),
...
class bachelor_written(Form):
    ...
    research = StringField(validators=[DataRequired()])
    namayesh_name = StringField(validators=[DataRequired()])
    back = SubmitField('بازگشت')
    add = SubmitField('ثبت')
    logout = SubmitField('خروج')
